...
public class DayAndNightControl : MonoBehaviour
{
    ...
    /// <summary>
    /// state för att ha koll på vad Arbetaren ska göra
    /// </summary>
    public enum DaystateOut
    {
        Day, Night, Morning, Evening
    }
    public DaystateOut currentWorkerDaystate;
    ...
    void CheckTimeOfDay()
    {
        ...
        {
            DayState = "Midnight";
            currentWorkerDaystate = DaystateOut.Night;
        }
        if (currentTime > 0.25f)
        {
            DayState = "Morning";
            currentWorkerDaystate = DaystateOut.Day;
        }
        ...
        if (currentTime > 0.64f && currentTime < 0.75f)
        {
            DayState = "Evening";
            currentWorkerDaystate = DaystateOut.Evening;           
        }
